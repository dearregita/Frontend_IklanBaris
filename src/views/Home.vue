            ...
            <div class="slider-active owl-carousel">
                    ...
                    <div class="container">
                        <div class="slider-content slider-animation slider-content-style-fashion slider-animated-1">
                            <div class="text-bg animated">
                                <a class="tilter-2 animated" href="img/slider/mobil1.jpg" alt=""></a>
                            </div>
                ...
                <div class="single-slider single-slider-hm1 bg-img height-100vh" style="background-image: url(assets/img/slider/14.jpg)">
                    <div class="container">
                        <div class="slider-content slider-animation slider-content-style-fashion slider-animated-1">
                            <div class="text-bg animated">
                                <img class="tilter-2 animated" src="img\product\electro\hp1.jpg" alt="">
                            </div>
                            <p class="animated">Create you own style for better looks. </p>
                        </div>
                    </div>
                            ...
                            <div class="custom-row">
                                <div class="custom-col-5 custom-col-style mb-65">
                                    <div class="product-wrapper">
                                        <div class="product-img">
                                            <a href="#">
                                                <img src="img/slider/mobil1.jpg" alt="">
                                            </a>
                                            <span>hot</span>
                                            <div class="product-action">
                                                <a class="animate-right" title="Quick View" href="/detail">
                                ...
                                <div class="custom-col-5 custom-col-style mb-65">
                                    <div class="product-wrapper">
                                        <div class="product-img">
                                            <a href="#">
                                                <img src="img\product\electro\hp1.jpg" alt="">
                                            </a>
                                            <div class="product-action">
                                                <a class="animate-left" title="Wishlist" href="#">
                                                    <i class="pe-7s-like"></i>
                                                </a>
                                                <a class="animate-top" title="Add To Cart" href="detail.html">
